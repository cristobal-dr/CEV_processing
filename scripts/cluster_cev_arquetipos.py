...
"""Clusterizacion CEV principal.

Esta version usa `calef_proyec_kwh` y `acs_proyec_kwh` como variables numericas
por defecto. El flujo anterior basado en descripciones textuales de equipos se
archivo en `scripts/old/` porque las categorias de texto libre fragmentaban los
datos y elevaban fuertemente el ruido de HDBSCAN.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=True,
        help="Usa calef_proyec_kwh y acs_proyec_kwh como variables numericas. Es el modo principal.",
    )
    parser.add_argument(
        "--use-log-kwh-systems",
        action=argparse.BooleanOptionalAction,
